...
Attali D, Edwards T (2021). _shinyalert: Easily Create Pretty Popup Messages (Modals) 
in 'Shiny'_. R package version 3.0.0, https://CRAN.R-project.org/package=shinyalert.
